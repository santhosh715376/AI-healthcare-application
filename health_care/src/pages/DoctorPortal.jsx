...
export default function DoctorPortal() {
  // Doctor Auth State
  const [docLicense, setDocLicense] = useState('NMC-TN-88492');

  // Active Patient Lookup State
  const [searchMobile, setSearchMobile] = useState('+91 9876543210');
  ...
  return (
    <div className="doctor-portal-container">
      ...
      <div style={{
        ...
        {/* Patient Mobile Search Bar */}
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <span style={{ fontSize: '0.85rem', color: '#9ca3af' }}>Patient Mobile:</span>
          <input
            type="text"
            className="transcript-area"
            style={{ width: '160px', height: '32px', fontSize: '0.85rem' }}
            value={searchMobile}
      ...
      {activeSubTab === 'history' && <TimelinePage />}
    </div>
  );
}
